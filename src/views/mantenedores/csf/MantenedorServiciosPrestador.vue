...
import TablaServiciosPrestador from '@/components/tablas/mantenedores/csf/TablaServiciosPrestador.vue';
export default {
    components: {
        DrawerMenu, TablaServiciosPrestador
    }
}
</script>
