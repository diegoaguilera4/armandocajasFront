...
export default {
    ...
    methods: {
        ...
        async obtenerArmado() {
            try {
                ...
                await axios.get(`/armados/${this.$route.params.id}/${user.prestador[0].prestadorId}`, {
                    ...
                    this.maquinaSeleccionada = this.formularioAntiguo.maquina ? this.formularioAntiguo.maquina : {
                        id: 0,
                        nmaquina: '',
                        nombre: '',
                        marca: '',
        ...
        compararFormulario() {
            ...
            if (this.formularioAntiguo.maquina && this.tipoMaquina === 'Externa') {
                comparar = true;
            }
            if (!this.formularioAntiguo.maquina && this.tipoMaquina === 'CSF') {
                comparar = true;
            }
            if (this.formularioAntiguo.maquina) {
            ...
            if (this.formularioAntiguo.nroTroquel != this.nroTroquel) {
                comparar = true;
            }
            if (this.formularioAntiguo.nroLoteAdhesivo != this.nroLoteAdhesivo) {
                comparar = true;
            }
            return comparar;
        },
